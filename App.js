    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src = "https://th.bing.com/th/id/OIP.ihmdFUsOYb-UXsWgZMaeMAHaHa?w=165&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"/>
            </div>
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {resList.map((resData) => <RestaurantCard key={resData.data.id} resData={resData} />)}
            </div>
